...
| ------------------------------------------------------------- | ----------: | ---------------------: | -------------------: | ---------: | --------: | ------------: |
| [stackoverflow.blog](https://stackoverflow.blog/)             |         142 |                   3.7% |                32.3% |       7.9% |      4.4% |          4.6% |
...
| [developer.mozilla.org](https://developer.mozilla.org/en-US/) |         107 |                  37.9% |                42.1% |      49.3% |     40.2% |         39.9% |
...
| **Avg. minify rate**                                          |             |              **10.7%** |            **24.0%** |  **18.1%** | **14.1%** |     **11.6%** |
